...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 flex items-center gap-2.5 bg-[#25D366] text-white p-3.5 lg:pl-3 lg:pr-4 lg:py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 group"
