...
const FAQS = [
  { q: "How do I book a PG through HeyStay?", a: "Browse listings, pick a PG you like, and fill out the enquiry form on the detail page. The PG owner will contact you within 24 hours to confirm availability and schedule a visit." },
  ...
  { q: "Is there a security deposit?", a: "Security deposit varies by PG, typically 1–2 months' rent. This is paid directly to the PG owner and is refundable per that PG's terms." },
