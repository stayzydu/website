...
const FAQS = [
  { q: "How do I book a PG through Stayzy?", a: "Browse listings, pick a PG you like, and fill out the enquiry form on the detail page. The PG manager will contact you within 24 hours to confirm availability and schedule a visit." },
  { q: "Are the PGs verified?", a: "Yes. Every PG listed on Stayzy is physically verified by our team. We check amenities, safety standards, and match the listing details before publishing." },
  ...
  { q: "How do I report an issue with a PG?", a: "You can reach us at support@stayzy.in. If a listing doesn't match what was advertised, we'll investigate and take necessary action including delisting." },
];
